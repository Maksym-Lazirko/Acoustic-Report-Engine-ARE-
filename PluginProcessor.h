...
private:
    ...
    std::atomic<bool> realtimeMonitoringEnabled { false };

public:
    void setRealtimeMonitoringEnabled (bool v) noexcept { realtimeMonitoringEnabled = v; }
    bool isRealtimeMonitoringEnabled() const noexcept { return realtimeMonitoringEnabled.load(); }
